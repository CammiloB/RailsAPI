...
class LyricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lyric" do
    assert_difference('Lyric.count') do
      post lyrics_url, params: { lyric: { Album: @lyric.Album, belongs_to: @lyric.belongs_to, date: @lyric.date, image: @lyric.image, name: @lyric.name } }, as: :json
    end
  ...
  test "should update lyric" do
    patch lyric_url(@lyric), params: { lyric: { Album: @lyric.Album, belongs_to: @lyric.belongs_to, date: @lyric.date, image: @lyric.image, name: @lyric.name } }, as: :json
    assert_response 200
  end
