...
class SelectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create selection" do
    assert_difference('Selection.count') do
      post selections_url, params: { selection: { belongs_to: @selection.belongs_to } }, as: :json
    end
  ...
  test "should update selection" do
    patch selection_url(@selection), params: { selection: { belongs_to: @selection.belongs_to } }, as: :json
    assert_response 200
  end
